"""
Created on Friday April 12 16:53:34 2020
...
class University:
    ...
    def instructor_summary_database(self):
        ...
        db: sqlite3.Connection = sqlite3.connect("/Users/nikhilkalyan/PycharmProjects/SSW 810/810_startup.db")
        sql_query: str = "SELECT CWID, Name, Dept, Courses, COUNT(*) " \
                         "FROM Grades JOIN Instructor on InstructorCWID = CWID " \
                         "GROUP BY CWID, Courses ORDER BY CWID DESC, Courses DESC"
    ...
    def student_summary_database(self):
        ...
        db: sqlite3.Connection = sqlite3.connect("/Users/nikhilkalyan/PycharmProjects/SSW 810/810_startup.db")
        sql_query: str = "SELECT Name, CWID, Courses, Grade, Name AS 'Instructor' " \
                         "FROM Grades  JOIN students  ON StudentCWID = s.CWID " \
                         "JOIN Instructor ON InstructorCWID = CWID ORDER BY Name"
    ...
    def print_grades_prettytable(self):
        ...
        for row in self.student_summary_database():
            prettytable.add_row(row)
        print(prettytable)
